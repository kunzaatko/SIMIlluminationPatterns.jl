...
```
"""
function bead(T::Type{<:Real}, d::Length, Δxy::NTuple{2,Length}; α::PerLength=0u"nm^-1", pixel_grid_length=10, peak_intensity=one(T), subpixel_shift=(0, 0))::OffsetMatrix{T}
...
bead(d::Length, Δxy::NTuple{2,Length}; vargs...) = bead(Float64, d, Δxy; vargs...)
bead(T::Type{<:Real}, d::Length, Δxy::Length; vargs...) = bead(T, d, (Δxy, Δxy); vargs...)
bead(d::Length, Δxy; vargs...) = bead(Float64, d, Δxy; vargs...)
